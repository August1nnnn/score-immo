...
BRIEF_PROMPT_TEMPLATE = """Tu es un strategiste SEO et GEO (Generative Engine Optimization) francais specialise en niche animale (litieres chat).
...
REQUETE : "{keyword}"
MARCHE CIBLE : France, chat domestique, proprietaires francophones
NOTRE POSITIONNEMENT : LitiereScore, comparateur independant, grille A-E publique sur 7 criteres
