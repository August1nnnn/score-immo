    ...
    "@graph": [
      {
        ...
        "name": "Score-Immo",
        "alternateName": "ScoreImmo",
        "url": "https://score-immo.fr",
        "logo": "https://score-immo.fr/favicon.svg",
        "description": "Plateforme française d'analyse de biens immobiliers à partir de données publiques, conçue pour aider l'acheteur à examiner une annonce avant sa décision.",
